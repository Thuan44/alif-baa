...
const Home = () => {
    ...
    return (
        <>
            ...
            <meta
                name="description"
                content="Bienvenue sur Alifbaa, l’application pour apprendre l’alphabet arabe, pratiquer l’écrit et la prononciation avec des quiz et des modes d’entraînement interactifs."
            />
